...
*   S3DIS: Download it from here: http://buildingparser.stanford.edu/dataset.html 

https://drive.google.com/drive/folders/0BweDykwS9vIoUG5nNGRjQmFLTGM?resourcekey=0-dHhRVxB0LDUcUVtASUIgTQ
...
*  Point Cloud Part Segmentation with 2D knowledge (learning without forgetting): ```python train_partseg_lwf.py```